...
({
    ...
    // name: "foo/bar/bop",
    include: ["./json-graph.js"],
    // insertRequire: ['foo/bar/bop'],
    out: "./built/json-graph.js",
    ...
    wrap: {
        start: "window.jsonGraph = {}; var lodash = window._; (function(exports) {",
        end: "}(window.jsonGraph));"
    },
