...
describe('JsonGraph', function () {
    ...
    describe('observe', function () {
        ...
        it('should emit changes when the value in the path changes', function () {
            ...
            chai_1.expect(emitted[0]).to.equal('hi');
            chai_1.expect(emitted[1]).to.equal('bye');
            chai_1.expect(emitted[2]).to.equal('in the sky');
            chai_1.expect(emitted[3]).to.equal('I\'m a monkey');
        });
    });
});
